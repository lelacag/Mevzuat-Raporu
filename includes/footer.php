    ...
    <footer class="footer-container">
        <div class="footer-content">
            <div class="footer-links">
                ...
                <a href="<?= BASE_PATH ?>/guvenlik-merkezi">Güvenlik</a>
                <a href="<?= kvkk_url() ?>">KVKK</a>
                <a href="<?= cookie_policy_url() ?>">Çerezler</a>
                <a href="<?= BASE_PATH ?>/rss.xml">RSS</a>
                <a href="<?= BASE_PATH ?>/turkce-nlp-demo">Türkçe NLP Demo</a>
                <?php if (is_admin()): ?>
                    <a href="<?= BASE_PATH ?>/admin/">Yönetim</a>
                <?php endif; ?>
            </div>
            <div class="footer-text">
                &copy; <?= date('Y') ?> <?= SITE_NAME ?> açık kaynaklı özgür bir platformdur. Kaynak kodları yakın zamanda erişime açılacaktır.
            </div>
        </div>
    </footer>
</body>
