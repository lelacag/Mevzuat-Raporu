...
// If current user is a rookie and NOT premium, intercept and show the Premium CTA then return to the post
if ($current_user && isset($current_user['role']) && $current_user['role'] === 'rookie' && !is_user_premium($user_id)) {
        ...
        <h1 class="danger-title">🗑️ Gönderiyi Sil</h1>
            ...
            <div class="panel-muted">
                <div class="panel-meta">
                    <strong class="meta-strong">Gönderi #<?= $post['id'] ?></strong>
            ...
            <?php $back = validate_referer($_SERVER['HTTP_REFERER'] ?? BASE_PATH . '/index.php', BASE_PATH . '/index.php', false); ?>
