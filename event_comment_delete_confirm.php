...
<div class="main-container single-column">
    <main class="content-area form-centered">
        <article class="card-box padded">
            <h1>Yorumu Sil</h1>
            <p>Bu yorumu silmek istediğinize emin misiniz? İşlem geri alınamaz.</p>
            ...
            <div style="display:flex;gap:10px;">
                <a href="<?= BASE_PATH ?>/event_view.php?id=<?= $event_id ?>#comment-<?= $comment_id ?>" class="btn btn-cancel">İptal</a>
