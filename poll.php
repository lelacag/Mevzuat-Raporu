    ...
    <main class="content-area narrow">
        ...
        <div class="post-form-container">
            ...
            <?php endif; ?>                <input type="hidden" name="csrf_token" value="<?= $csrf_token ?>">
                ...
                <div class="form-row" style="margin-top:12px; margin-left:auto; margin-right:auto; max-width:560px;">
                    <label for="poll-content"><strong>Açıklama</strong></label>
                    <textarea id="poll-content" name="content" placeholder="Anket sorusu veya açıklama" required class="post-textarea"><?= htmlspecialchars($_POST['content'] ?? ($editing ? $edit_poll_content : '')) ?></textarea>
                </div>
                    ...
                    <div class="poll-options">
                        <?php foreach ($options as $i => $opt): $idx = $i + 1; ?>
                            <div style="margin-bottom:8px;">
                                <input type="text" class="post-option-input" name="option_<?= $idx ?>" value="<?= htmlspecialchars($opt) ?>" placeholder="Seçenek <?= $idx ?>">
                            </div>
                        <?php endforeach; ?>
                    </div>
                    <div style="margin-top:8px;">
                        <button type="submit" name="add_option" value="1" class="btn-small" formnovalidate aria-label="Yeni seçenek ekle">➕ Yeni Seçenek</button>
                    </div>
                </div>
                ...
                <div style="margin-top:16px; margin-left:auto; margin-right:auto; max-width:560px;">
                    ...
                    <?php endif; ?>
                    <a href="<?= BASE_PATH ?>/index.php" class="btn-cancel">İptal</a>
                </div>
            </form>
        </div>
        <?php endif; ?>
