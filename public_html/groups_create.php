...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // require_csrf() validates and consumes the token from the session pool.
    // Do not call verify_csrf_token() again here because the token is single-use.
    require_csrf();
    ...
    <aside class="sidebar sidebar-left">
        <div class="sidebar-section">
            ...
            <ul class="sidebar-list">
                <li><a href="<?= BASE_PATH ?>/topluluklar">← Gruplara Dön</a></li>
        ...
        <div class="post-form-container">
            <form method="POST" class="post-form">
                ...
                <div class="post-form-actions">
                    <a href="<?= BASE_PATH ?>/topluluklar" class="btn-cancel">İptal</a>
