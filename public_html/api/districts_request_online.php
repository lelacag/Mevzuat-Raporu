...
try {
    ...
    if (!$membership || $membership['role'] !== 'admin') {
        ...
        echo http_build_query(['success' => '0', 'error' => 'Only district admins can request online access']);
        exit;
    }
    ...
    if ($existing) {
        echo http_build_query(['success' => '0', 'error' => 'District already has a ' . $existing['status'] . ' online request']);
        exit;
    }
