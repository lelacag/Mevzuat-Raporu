    ...
    <aside class="sidebar sidebar-left">
        <div class="sidebar-section">
            ...
            <ul class="sidebar-list">
                <li><a href="<?= BASE_PATH ?>/group.php?slug=<?= urlencode($slug) ?>">← Gruba Dön</a></li>
    ...
    <main class="content-area">
        ...
        <div style="padding:20px;">
            ...
            <form method="POST" action="<?= BASE_PATH ?>/api/group_post_delete.php">
                ...
                <input type="hidden" name="referer" value="<?= BASE_PATH ?>/group.php?slug=<?= urlencode($slug) ?>">
                
                <div style="display:flex;gap:10px;">
                    <button type="submit" class="btn-join-group btn-leave-group" style="background:#e74c3c;">Evet, Sil</button>
                    <a href="<?= BASE_PATH ?>/group.php?slug=<?= urlencode($slug) ?>" class="btn-join-group" style="text-decoration:none;">Hayır, İptal</a>
                </div>
            </form>
        </div>
    </main>
