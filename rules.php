...
<div class="main-container single-column">
	<main class="content-area">
		...
		<div style="padding:20px;line-height:1.6;font-size:13px;">
			...
			<p style="margin-top:20px;">Bu kurallar Mevzuat Raporu tarafından belirlenmiştir. Sorular için <a href="<?= BASE_PATH ?>/suggestions.php">destek</a> bölümüne başvurun.</p>
		</div>
